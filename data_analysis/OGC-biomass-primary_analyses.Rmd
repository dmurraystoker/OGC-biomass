...
```{r Discharge t-Tests, results = FALSE}
## Winter discharge
...
```{r Water Temperature t-Tests, results = FALSE}
...
```{r Air Temperature t-Tests, results = FALSE}
...
```{r Precipitation t-Tests, results = FALSE}
