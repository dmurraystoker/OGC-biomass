...
percent.consumer.biomass.change <- (
	mean(consumer.biomass.2010s.total.biomass)/mean(consumer.biomass.1980s.total.biomass)
	)*100
# 2010s biomass = 47.80% of 1980s biomass
```
