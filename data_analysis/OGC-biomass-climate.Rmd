...
ANOVAs were conducted for discharge and each climate parameter, testing the effect of period, season, and the interaction with Type II sums-of-squares. ANOVA assumptions were inspected graphically using `check_model()`, and effect sizes for the ANOVAs were calculated as $\eta^2_P$ using `eta_squared()`.
